...
ActiveRecord::Schema.define(version: 20170123140134) do
  ...
  add_index "coments", ["article_id"], name: "index_coments_on_article_id", using: :btree
  add_index "coments", ["category_id"], name: "index_coments_on_category_id", using: :btree
  add_index "coments", ["coment_id"], name: "index_coments_on_coment_id", using: :btree
  ...
  add_index "subscribers", ["mail"], name: "index_subscribers_on_mail", unique: true, using: :btree
